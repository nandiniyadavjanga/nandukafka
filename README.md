...
PowerShell
java -cp target/nandukafka-1.0-SNAPSHOT-jar-with-dependencies.jar com.kafka.nandu.CustomConsumer
...
PowerShell
java -cp target/nandukafka-1.0-SNAPSHOT-jar-with-dependencies.jar com.kafka.nandu.CustomProducer
